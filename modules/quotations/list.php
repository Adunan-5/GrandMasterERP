    ...
    $(function () {
        ...
        if (dt_invoice_table.length) {
            ...
            var dt_invoice = dt_invoice_table.DataTable({
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            var $row_output = '<a class="text-truncate" href="/quotation/edit/' + $documentId + '"># ' + $quotationNumber + '</a>';
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            } else if ($status === "APPROVED" || $status === "CONFIRMED" || $status === "CUSTOMER ACCEPTED") {
                                $badge_class = 'bg-label-success';
                                return ('<span class="badge ' + $badge_class + '" text-capitalized>' + $status + '</span>');
                            } else if ($status === "REJECTED" || $status === "CUSTOMER REJECTED") {
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            let $row_output;
                            if (full['PONumber'] != null) {
                                $row_output = '<span class="text-truncate">' + $PONumber + '</span>';
                            } else {
                                $row_output = "-";
                            }
                            return $row_output;
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            let $row_output;
                            if (full['margin'] != null) {
                                $row_output = '<span class="text-truncate">' + $margin + '</span>';
                            } else {
                                $row_output = "-";
                            }
                            return $row_output;
                ...
                buttons: [
                    <?php if (is_ceo() || has_permission('quotations', 'create')) { ?>
                    {
                ...
                responsive: {
                    details: {
                        display: $.fn.dataTable.Responsive.display.modal({
                            header: function (row) {
                                var data = row.data();
                                return 'Details of ' + data['quotationNumber'];
                            }
                        }),
                        type: 'column',
