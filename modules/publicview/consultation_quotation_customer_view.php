...
$PAGE_ID = "CONSULTATION_QUOTATION_CUSTOMER_VIEW";
                                    ...
                                    <div class="card-body card-widget-separator py-2">
                                        <div class="row gy-1 gy-sm-1">
                                            <div class="col-6">
                                                ...
                                                ?>
                                                <h4 class="my-0"><?= getQuotationNumberFromConsultationDocumentID($documentID) ?> </h4>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                                            ...
                                            <div>
                                                <h5 class="mb-6">Quotation
                                                    #<?= getQuotationNumberFromConsultationDocumentID($keyDocument->documentId) ?></h5>
                                        ...
                                        <table class="table m-0">
                                            ...
                                            while ($rowLineItem = mysqli_fetch_assoc($resLineItems)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20" class="text-nowrap"><?= getItemNameForItemID($rowLineItem['itemId']) ?></td>
                                                    <td ><?= getItemDescriptionForConsultationServiceItemID($rowLineItem['itemId']) ?></td>
                                                    <td><?= $rowLineItem['UOM'] ?></td>
                                        ...
                                        <table class="table m-0 table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end px-0 py-6 w-px-100 fw-medium text-heading">
                                                    <p class="fw-medium mb-2"><?= getTotalAmountByConsultationDocumentID($keyDocument->documentId)['totalAmountBeforeVAT'] ?></p>
                                                    <p class="fw-medium mb-2"><?= getTotalAmountByConsultationDocumentID($keyDocument->documentId)['totalDiscountAmount'] ?></p>
                                                    <p class="fw-medium mb-2 border-bottom pb-2"><?= getTotalAmountByConsultationDocumentID($keyDocument->documentId)['totalVATAmount'] ?></p>
                                                    <p class="fw-medium mb-0 pt-2"><?= getTotalAmountByConsultationDocumentID($keyDocument->documentId)['totalAmountAfterVAT'] ?></p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="card-body">
                                        ...
                                        if($keyDocument->quotationAcceptedByCustomer == STATUS_GENERIC_APPROVED || $keyDocument->quotationAcceptedByCustomer == STATUS_GENERIC_NEUTRAL)
                                        {
                                            ...
                                            <div class="d-flex mb-1">
                                                <a class="btn btn-label-info d-grid w-100 me-1" target="_blank" href="/consultation/quotation/print/<?=encryptString($keyDocument->documentId) ?>">
                                                    <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="ti ti-printer ti-xs me-2"></i>Print</span>
                                                </a>
                                                <a href="/consultation/quotation/download/<?=encryptString($keyDocument->documentId) ?>" class="btn btn-label-info d-grid w-100">
...
<script>
    ...
    function acceptQuotation() {
        ...
        $.ajax({
            url: '/ajax/consultation/customer_update_quotation_status.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
