...
<head>
    ...
    <title>GrandMaster ERP | E-commerce Orders</title>
</head>
<body>
<!-- Layout wrapper -->
                    ...
                    <div class="row invoice-preview">
                        ...
                        <div class="col-xl-10 col-md-10 col-12 mb-md-0 mb-6">
                                    ...
                                    <div class="card-body card-widget-separator py-2">
                                        <div class="row gy-1 gy-sm-1">
                                            <div class="col-6">
                                                ...
                                                ?>
                                                <h4 class="my-0">E-Commerce Order #<?= $keyDocument->orderId ?> </h4>
                                            </div>
                                            <div class="col-6 text-end">
                                                <?php
                                                switch ($keyDocument->orderStatus) {
                                                    case ORDER_STATUS_SENT_TO_CUSTOMER:
                                                        ?>
                            ...
                            if ($isCustomerAuthenticated === true) {
                                ...
                                <div class="card invoice-preview-card p-sm-12 p-6">
                                    <div class="card-body invoice-preview-header rounded">
                                        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                                            ...
                                            <div>
                                                <h5 class="mb-6">E-Commerce Order
                                                    #<?= $keyDocument->orderId ?></h5>
                                                <div class="mb-1 text-heading">
                                                    <span>Date Issued:</span>
                                                    <span><?= formatDate($keyDocument->orderDateIssued, false) ?></span>
                                                </div>
                                                <div class="mb-1 text-heading">
                                    ...
                                    <div class="card-body px-0">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-6 mb-sm-0 mb-6">
                                                <h6>E-Commerce Order For:</h6>
                                                <p class="mb-1"><?= $customerInfo->companyName ?></p>
                                                <p class="mb-1"><?= getEcommerceCustomerFormattedAddress($customerInfo)[0] ?></p>
                                        ...
                                        <table class="table m-0">
                                            ...
                                            while ($rowLineItem = mysqli_fetch_assoc($resLineItems)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $rowLineItem['shippingSubTotal'] ?></td>
                                        ...
                                        <table class="table m-0 table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0 py-6 w-px-100">
                                                    ...
                                                    <p class="mb-2">Tax:</p>
                                                    <p class="mb-2 border-bottom pb-2">Shipping:</p>
                                                ...
                                                <td class="text-end px-0 py-6 w-px-100 fw-medium text-heading">
                                                    ...
                                                    <p class="fw-medium mb-2"><?= getTotalAmountByDocumentID($keyDocument->documentId)['totalVATAmount'] ?></p>
                                                    <p class="fw-medium mb-2 border-bottom pb-2"><?= getTotalAmountByDocumentID($keyDocument->documentId)['totalShippingAmount'] ?></p>
                                                    <p class="fw-medium mb-0 pt-2"><?= getTotalAmountByDocumentID($keyDocument->documentId)['totalAmountAfterVATAndShipping'] ?></p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="alert alert-warning" role="alert">This order is password
                        ...
                        if ($isCustomerAuthenticated) {
                            ...
                            <div class="col-xl-2 col-md-2 col-12 invoice-actions">
                                <div class="card">
                                    <div class="card-body">
                                        <?php
                                        if($keyDocument->orderAcceptedByCustomer == STATUS_GENERIC_APPROVED)
                                        {
                                            ?>
                                            <div class="alert alert-primary" role="alert">
                                                <p>You have already accepted this order. If you have any queries, please contact us.</p>
                                            </div>

                                            <?php
                                        }
                                        elseif($keyDocument->orderAcceptedByCustomer == STATUS_GENERIC_REJECTED)
                                        {
                                            ?>
                                            <div class="alert alert-danger" role="alert">
                                                <p>You have rejected this order. If you have any queries, please contact us.</p>
                                            </div>
                                            <?php
                                        }else{
                                            ?>
                                        ...
                                        if($keyDocument->quotationAcceptedByCustomer == STATUS_GENERIC_APPROVED || $keyDocument->quotationAcceptedByCustomer == STATUS_GENERIC_NEUTRAL)
                                        {
                                            ...
                                            <div class="d-flex mb-1">
                                                <a class="btn btn-label-info d-grid w-100 me-1" target="_blank" href="/order/print/<?=encryptString($keyDocument->documentId) ?>">
                                                    <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="ti ti-printer ti-xs me-2"></i>Print</span>
                                                </a>
                                                <a href="/order/download/<?=encryptString($keyDocument->documentId) ?>" class="btn btn-label-info d-grid w-100">
...
<script>
    ...
    function acceptQuotation() {
        ...
        formData.append('status', '<?=ORDER_STATUS_CUSTOMER_ACCEPTED ?>');
        formData.append('rejectReason', "");

        $.ajax({
            url: '/ajax/documents/ecommerce_customer_update_order_status.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            success: function (data, status) {
                ...
                if (statusmessage == "SUCCESS") {
                    Swal.fire({
                        icon: 'success',
                        title: 'Accepted!',
                        text: 'Thank you for accepting the order. Have a great day!',
                        customClass: {
    ...
    function rejectQuotation(){
        ...
        if(rejectReason.length){
            ...
            var formData = new FormData();
            formData.append('documentID', documentID);
            formData.append('status', '<?=ORDER_STATUS_CUSTOMER_REJECTED ?>');
