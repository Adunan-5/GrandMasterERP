            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                            ...
                            <div class="d-flex justify-content-between align-items-center row pt-4 gap-6 gap-md-0">
                                <div class="col-md-4 product_status">
                                    <button class="btn btn-primary" onclick="downloadTemplate()" type="button">
                                        <i class="ti ti-download me-1"></i> Machines Import Template
                                    </button>
                                </div>
                                <div class="col-md-4 product_category"></div>
                                <div class="col-md-4 product_stock">
                                    <label for="importFile" class="form-label fw-bold mb-2">Import Machines Excel</label>
                        ...
                        <!-- Offcanvas to add new Machine -->
                        <div class="offcanvas offcanvas-end form-block" tabindex="-1" id="offcanvasMachineAdd" aria-labelledby="offcanvasEcommerceMachineAddLabel">
                            <div class="offcanvas-header">
                                <h5 id="offcanvasEcommerceMachineAddLabel" class="offcanvas-title">Add Machine</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body border-top mx-0 flex-grow-0">
                                <form class="ecommerce-machine-add pt-0" id="machineAddForm" method="POST" name="machineAddForm" action="/machine/list" enctype="multipart/form-data" onsubmit="return false;">
                                    <div class="ecommerce-machine-add-basic mb-4">
                                        <input type="hidden" name="itemType" value="MACHINE">
                                       <div class="mb-6">
                                           <label class="form-label" for="serialNumber">Serial Number*</label>
                                           <input type="text" class="form-control" id="serialNumber" placeholder="Enter Serial Number" name="serialNumber" aria-label="Serial Number" required/>
                                       </div>
                                        <div class="mb-6">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="Enter Machine Name" name="name" aria-label="Name" required/>
                                        </div>
                                        <div class="mb-6">
                                    ...
                                    <div>
                                        <button class="btn btn-primary me-sm-4 data-submit">Add Machine</button>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.status === 'SUCCESS') {
                            showSuccessMessage(result.message, gotoPage, "/machines/list");
                        } else {
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/spareparts/fetch_spare_parts.php?type=MACHINE',
                        columns: [
                        ...
                        buttons: [
                            ...
                            {
                                text: '<i class="ti ti-plus me-0 me-sm-1 mb-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Machine</span>',
                                className: 'add-new btn btn-primary waves-effect waves-light',
                                attr: {
                                    'data-bs-toggle': 'offcanvas',
                                    'data-bs-target': '#offcanvasMachineAdd'
                                }
                            }
                            <?php } ?>
                        ],
                        ...
                        responsive: {
                            details: {
                                display: $.fn.dataTable.Responsive.display.modal({
                                    header: function (row) {
                                        var data = row.data();
                                        return 'Details of ' + data['serialNumber'];
                                    }
                                }),
                                type: 'column',
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (params.has('addnew') || currentPath.includes('/new')) {
                    const offcanvasElement = document.getElementById('offcanvasMachineAdd');
                    if (offcanvasElement) {
            ...
            $(document).ready(function () {
                // Form Validation
                const SparepartAddForm = document.getElementById('machineAddForm');
                ...
                $("#machineAddForm").submit(function (e) {
                    e.preventDefault();
                    ...
                    fv.validate().then(function (status) {
                        if (status === 'Valid') {
                            ...
                            var form = $('#machineAddForm')[0]; // Standard JavaScript object
                                ...
                                success: function (data) {
                                    ...
                                    if (statusMessage === "SUCCESS") {
                                        Swal.fire({
                                            ...
                                            dismissOffcanvas('offcanvasMachineAdd');
                                            blockArea($('body'));
                                            location.reload();
                                        });
                                    } else if (statusMessage === "ERROR") {
