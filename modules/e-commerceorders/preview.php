        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <div class="col-6">
                                        ...
                                        ?>
                                        <h4 class="my-0"><?= $ecommerceOrderId ?> | Preview E-commerce Order </h4>
                                    </div>
                    ...
                    $ecommerceAddress = $customerInfo->ecommerceAddress[0];
...
<!--                                            <p class="mb-0">+1 (123) 456 7891, +44 (876) 543 2198</p>-->
                                        ...
                                        <div>
                                            <h5 class="mb-6">E-commerce Order #<?=$ecommerceOrderId ?></h5>
                                            <div class="mb-1 text-heading">
                                                <span>Date Issued:</span> <span><?=formatDate($keyDocument->orderDateIssued, false) ?></span>
                                            </div>
                                            <div class="mb-1 text-heading">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-4">
                                        <a class="btn btn-label-secondary d-grid w-100 me-4" target="_blank" href="./app-invoice-print.html">
                                            Print </a>
                                        <a href="/ecommerce/edit/<?=$keyDocument->documentId?>" class="btn btn-label-secondary d-grid w-100">
                                            Edit </a>
                                    </div>
