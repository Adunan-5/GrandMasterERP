<?php
$PAGE_ID = "SETTINGS_CONSULTATION_PROPOSAL_NEW_EDIT";
...
<head>
    ...
    <title>GrandMaster ERP | Proposal Templates</title>
</head>
<body>
<!-- Layout wrapper -->
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Proposal Templates</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 col-12 mb-lg-0 mb-6">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="/consultation/proposaltemplates?action=NEW" class="btn btn-primary"><i class="menu-icon tf-icons ti ti-plus"></i>Add</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <?php
                                            $res     = $db->query("SELECT * FROM consultation_proposal_templates");
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="/consultation/proposaltemplates?action=EDIT&templateID=<?= $row['proposalTemplateID'] ?>">
                                                                    <i class="menu-icon tf-icons ti ti-pencil"></i>Edit
                                                                </a>
                                                                <a class="dropdown-item" href="javascript:void(0);" onclick="deleteTemplate(<?= (int)$row['proposalTemplateID'] ?>)">
                                ...
                                <div class="col-lg-12 col-12 mb-lg-0 mb-6">
                                    <div class="card invoice-preview-card p-sm-6 p-6">
                                        <div class="card-body px-0">
                                            ...
                                            if ($isEditMode) {
                                                $resTemplate = $db->query("SELECT * FROM consultation_proposal_templates WHERE proposalTemplateID = ?s", $templateID);
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 col-sm-5 col-12 mb-sm-0 mb-6">
                                                    <div class="mb-4">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" id="proposalTemplateName" name="proposalTemplateName" placeholder="Website Development Template" aria-describedby="proposalTemplateNameHelp" required value="<?php if ($isEditMode) echo $rowTemplate['templateName'] ?>"/>
                                                            <div id="proposalTemplateNameHelp" class="form-text">Give it a meaningful name</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-7 col-sm-7">
                                                    <div class="mt-6 d-flex gap-2 justify-content-end">
                                                        ...
                                                        ?>
                                                        <a href="/consultation/proposaltemplates" class="btn btn-secondary mb-4">
                                ...
                                <div class="col-12 mt-6">
                                    ...
                                    <div class="card mb-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="contentIntroduction" class="snow-editor"><?php if ($isEditMode) echo $rowTemplate['contentIntroduction'] ?></div>
                                        </div>
                                    </div>
                                    <!--Introduction Ends-->
                                    <!--contentWhyChooseUs Starts-->
                                    <div class="card mb-6">
                                        <h5 class="card-header">Why Choose Us</h5>
                                        <div class="card-body">
                                            <?php include __DIR__ . "/../../includes/snow_editor_toolbar.php"; ?>
                                            <div id="contentWhyChooseUs" name="contentWhyChooseUs" class="snow-editor"><?php if ($isEditMode) echo $rowTemplate['contentWhyChooseUs'] ?></div>
                                        </div>
                                    </div>
                                    <!--contentWhyChooseUs Ends-->
                                    <!--contentClientResponsibilities Starts-->
                                    <div class="card mb-6">
                                        <h5 class="card-header">Client Responsibilities</h5>
                                        <div class="card-body">
                                            <?php include __DIR__ . "/../../includes/snow_editor_toolbar.php"; ?>
                                            <div id="contentClientResponsibilities" name="contentClientResponsibilities" class="snow-editor"><?php if ($isEditMode) echo $rowTemplate['contentClientResponsibilities'] ?></div>
                                        </div>
                                    </div>
                                    <!--contentClientResponsibilities Ends-->
                                    <!--contentTermsAndConditions Starts-->
                                    <div class="card mb-6">
                                        <h5 class="card-header">Terms & Conditions</h5>
                                        <div class="card-body">
                                            <?php include __DIR__ . "/../../includes/snow_editor_toolbar.php"; ?>
                                            <div id="contentTermsAndConditions" name="contentTermsAndConditions" class="snow-editor"><?php if ($isEditMode) echo $rowTemplate['contentTermsAndConditions'] ?></div>
                                        </div>
                                    </div>
                                    <!--contentTermsAndConditions Ends-->
                                    <!--contentNextSteps Starts-->
                                    <div class="card mb-6">
                                        <h5 class="card-header">Next Steps</h5>
                                        <div class="card-body">
                                            <?php include __DIR__ . "/../../includes/snow_editor_toolbar.php"; ?>
                                            <div id="contentNextSteps" name="contentNextSteps" class="snow-editor"><?php if ($isEditMode) echo $rowTemplate['contentNextSteps'] ?></div>
                                        </div>
                                    </div>
                                    <!--contentTermsAndConditions Ends-->
                                </div>
...
<script>
    ...
    $(document).ready(function (e) {
        ...
        $("#templateForm").submit(function (e) {
            ...
            var dataToSend = {
                templateName: $("#proposalTemplateName").val(),
                contentIntroduction: quillEditors['contentIntroduction'].root.innerHTML,
                contentWhyChooseUs: quillEditors['contentWhyChooseUs'].root.innerHTML,
                contentClientResponsibilities: quillEditors['contentClientResponsibilities'].root.innerHTML,
                contentTermsAndConditions: quillEditors['contentTermsAndConditions'].root.innerHTML,
                contentNextSteps: quillEditors['contentNextSteps'].root.innerHTML
            };

            $.ajax({
                url: '/ajax/consultation/save_template.php',
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if (response.status === "success") {
                        // Do something
                        showSuccessMessage(response.message, gotoPage, "/consultation/proposaltemplates");
    ...
    function updateTemplate() {
        ...
        $.ajax({
            url: '/ajax/consultation/update_template.php',
            type: 'POST',
            data: JSON.stringify(dataToSend),
            contentType: 'application/json',
            dataType: 'json',
