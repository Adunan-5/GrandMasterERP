                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Service Maintenance Agreements (SMA)</h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function () {
        ...
        if (dt_invoice_table.length) {
            ...
            let ajaxURL = '/ajax/consultation/fetch_sma.php';
            ...
            var dt_invoice = dt_invoice_table.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function (data, type, full, meta) {
                            var $documentId = full['smaID'];
                            return (
                                '<div class="d-flex align-items-center">' +
                                '<a href="/consultation/sma/preview/' + $documentId + '" data-bs-toggle="tooltip" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill" data-bs-placement="top" title="Preview SMA"><i class="ti ti-eye mx-2 ti-md"></i></a>' +
                                '<div class="dropdown">' +
                                ...
                                '<a href="/consultation/sma/edit?smaID=' + $documentId + '" class="dropdown-item">Edit</a>' +
                                '</div>' +
                                '</div>'
                            );
                        }
                    },
                    {
                        ...
                        targets: 2,
                        render: function (data, type, full, meta) {
                            var $smaNumber = full['smaNumber'];
                            var $documentId = full['smaID'];
                            var $quotationDate = full['dateCreated'];

                            // Creates full output for row
                            var $row_output = '<a class="text-truncate" href="/consultation/sma/edit?smaID=' + $documentId + '"># ' + $smaNumber + '</a>';
                    ...
                    },
                    {
                        ...
                        targets: 5,
                        render: function (data, type, full, meta) {
                            var $quotationDate = new Date(full['dateCreated']);
                    ...
                    },
                    {
                        ...
                        targets: 6,
                        render: function (data, type, full, meta) {
                            var $dueDate = new Date(full['totalAmount']);

                            let $row_output;
                                $row_output = full['totalAmount'];
                ...
                buttons: [
                    {
                        text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">New SMA</span>',
                        className: 'btn btn-primary waves-effect waves-light',
                        action: function (e, dt, button, config) {
                            window.location = '/consultation/sma/new';
                        }
                    }
                ],
