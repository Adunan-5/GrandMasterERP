<?php
$PAGE_ID = "CONSULTATION_PROPOSAL_LIST";
                        ...
                        <div class="card-datatable table-responsive">
                            <table class="invoice-list-table table border-top">
                                ...
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th class="text-truncate">Proposal #</th>
                                    <th class="cell-fit">Customer</th>
                                    <th>Payment Term</th>
                                    <th>Status</th>
                                    <!--                                    <th  class="text-truncate">Sale Order</th>-->
                                    <th class="text-truncate">Date</th>
                                    <th class="text-truncate">Valid Until</th>
                                    <th>Amount</th>
                                    <th>Created By</th>
...
<script>
    ...
    $(function () {
        ...
        if (dt_invoice_table.length) {
            ...
            let ajaxURL = '/ajax/consultation/fetch_proposals.php';
            ...
            var dt_invoice = dt_invoice_table.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function (data, type, full, meta) {
                            var $documentId = full['proposalID'];
                            return (
                                '<div class="d-flex align-items-center">' +
                                '<a href="/consultation/proposal/preview/' + $documentId + '" data-bs-toggle="tooltip" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill" data-bs-placement="top" title="Preview Proposal"><i class="ti ti-eye mx-2 ti-md"></i></a>' +
                                '<div class="dropdown">' +
                                ...
                                '<a href="/consultation/proposal/edit?proposalID=' + $documentId + '" class="dropdown-item">Edit</a>' +
                                '</div>' +
                                '</div>'
                            );
                        }
...

                    {
                        ...
                        targets: 2,
                        render: function (data, type, full, meta) {
                            var $proposalNumber = full['proposalNumber'];
                            var $documentId = full['proposalID'];
                            var $quotationDate = full['preparedOn'];

                            // Creates full output for row
                            var $row_output = '<a class="text-truncate" href="/consultation/proposal/edit?proposalID=' + $documentId + '"># ' + $proposalNumber + '</a>';
                    ...
                    },
                    {
                        ...
                        targets: 6,
                        render: function (data, type, full, meta) {
                            var $quotationDate = new Date(full['preparedOn']);

                            let $row_output;
                            if (full['preparedOn'] != null) {
                    ...
                    },
                    {
                        ...
                        targets: 7,
                        render: function (data, type, full, meta) {
                            var $dueDate = new Date(full['validUntil']);

                            let $row_output;
                            if (full['validUntil'] != null) {
                ...
                buttons: [
                    {
                        text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">New Proposal</span>',
                        className: 'btn btn-primary waves-effect waves-light',
                        action: function (e, dt, button, config) {
                            window.location = '/consultation/proposal/new';
                        }
                    }
                ],
