<?php
$PAGE_ID = "CONSULTATION_INVOICE_NEW";
...
<head>
    ...
    <title>GrandMaster ERP | Consultation Invoice</title>
</head>
<body>
<!-- Layout wrapper -->
                            ...
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <div class="col-6">
                                        ...
                                        $res          = $db->query("SELECT * FROM consultation_key_documents WHERE documentId = ?s", $refDocID);
                                        ...
                                        foreach ($itemIds as $itemId) {
                                            $res = $db->query("SELECT * FROM consultation_line_items WHERE documentId = ?s AND itemId = ?s", $refDocID, $itemId);
                                        ...
                                        ?>
                                        <h4 class="my-0"><?= getSalesOrderNumberFromConsultationDocumentID($refDocID) ?></h4>
                                    </div>
                                                    ...
                                                    <div class="d-flex border rounded position-relative pe-0">
                                                        <div class="row w-100 p-3">
                                                            ...
                                                            <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                                ...
                                                                <input name="servicedescription" type="text" class="form-control mb-5" readonly value="<?= $lineItemInfo['description'] ?>"/>
                                                ...
                                                <div class="repeater-wrapper pt-0 pt-md-6" data-repeater-item>
                                                    <div class="d-flex border rounded position-relative pe-0">
                                                        <div class="row w-100 p-3">
                                                            ...
                                                            <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                                <p class="h6 mb-1">Description</p>
                                                                <input name="servicedescription" type="text" class="form-control mb-5"/>
                                                                <div class="text-heading" style="display: none">
                                                                    <div class="mb-1">Discount:</div>
                                                                    <span class="discount me-2">0%</span>
                                                                    <span class="tax-1 me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Tax 1">0%</span>
