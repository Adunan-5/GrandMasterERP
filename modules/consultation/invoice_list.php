                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            return (
                                ...
                                '<a href="/ajax/invoice/generate_pdf.php?isdownload=1&invoiceID=' + $invoiceId + '" class="dropdown-item">Download</a>' +
                                '<a href="/invoice/edit/' + $invoiceId + '" class="dropdown-item">Edit</a>' +
                                '</div>' +
                                '</div>'
                            );
                        }
...

                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            var $row_output = '<a class="text-truncate" href="/invoice/edit/' + $invoiceId + '"># ' + $invoiceNumber + '</a>';
