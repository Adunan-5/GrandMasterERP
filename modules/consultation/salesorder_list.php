<?php
$PAGE_ID = "CONSULTATION_SALESORDER_LIST";
    ...
    $(function () {
        ...
        if (dt_invoice_table.length) {
            var dt_invoice = dt_invoice_table.DataTable({
                ajax: '/ajax/consultation/fetch_salesorders.php',
                columns: [
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            var $row_output = '<a class="text-truncate" href="/consultation/salesorders/edit/' + $documentId + '"># ' + $salesOrderNumber + '</a>';
                            // '<br><small class="text-truncate">' + moment($salesOrderDate).format('DD MMM YYYY') + '</small>';
                            return $row_output;
                        }
                    },
                    {
