<?php
$PAGE_ID = "CONSULTATION_CATEGORIES";
                            ...
                            <table class="invoice-list-table table border-top">
                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-heading text-wrap fw-medium"><?= $row['categoryName'] ?></span>
                                             <br>
                                            <span class="text-truncate mb-0 d-none d-sm-block"><small><?= $row['description'] ?></small></span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:;"
                                                   ...
                                                   data-categorydescription="<?= $row['description'] ?>"
                                                   data-categoryid="<?= $row['categoryId'] ?>"
                                                   data-categorystatus="<?= $row['active'] ?>" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCategoryEdit" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill categoryEditButton" data-bs-placement="top" title="Edit"><i class="ti ti-pencil mx-2 ti-md"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                        ...
                        <form class="ecommerce-customer-add pt-0" id="categoryAddForm" method="POST" name="categoryAddForm" onsubmit="return false;">
                            <div class="ecommerce-customer-add-basic mb-4">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" id="categoryName" placeholder="App Development" name="categoryName" aria-label="App Development"/>
                                </div>
                                <div class="mb-6">
                    ...
                    <div class="offcanvas-body border-top mx-0 flex-grow-0">
                        <form class="ecommerce-customer-add pt-0" id="categoryEditForm" method="POST" name="categoryEditForm" onsubmit="return false;">
                            <div class="ecommerce-customer-add-basic mb-4">
                                ...
                                <div class="mb-6">
                                    <label class="form-label" for="categoryName">Category Name*</label>
                                    <input type="text" class="form-control" id="editCategoryName" placeholder="App Development" name="categoryName" aria-label="App Development"/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="categoryDescription">Description</label>
        ...
        $("#categoryAddForm").submit(function (e) {
            ...
            fv.validate().then(function (status) {
                if (status === 'Valid') {
                    ...
                    $.ajax({
                        url: '/ajax/consultation/add_category.php',
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
        ...
        $("#categoryEditForm").submit(function (e) {
            ...
            editFormValidation.validate().then(function (status) {
                if (status === 'Valid') {
                    ...
                    $.ajax({
                        url: '/ajax/consultation/edit_category.php',
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
