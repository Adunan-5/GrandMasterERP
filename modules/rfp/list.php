...
<head>
  ...
  <title>GrandMaster ERP | RFPs</title>
...
<script>
  ...
  $(function () {
    ...
    if (dt_invoice_table.length) {
      ...
      let ajaxURL = '/ajax/rfpdocument/fetch_rfps.php';
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              return (
                ...
                '<a href="/rfp/edit/' + $rfpId + '" class="dropdown-item">Edit</a>' +
                '</div>' +
                '</div>'
              );
            }
...

          {
            ...
            render: function (data, type, full, meta) {
              ...
              var $row_output = '<a class="text-truncate" href="/rfp/edit/' + $rfpId + '"># ' + $rfpNumber + '</a>';
