...
<head>
    ...
    <title>GrandMaster ERP | Accounts Payable</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Accounts Payable</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/accounting/fetch_accounts_payable.php',
                        columns: [
                      ...
                      columnDefs: [
                        ...
                        },
                        {
                          ...
                          render: function (data, type, full, meta) {
                            ...
                            var stateNum = Math.floor(Math.random() * 6),
                              ...
                              $initials = $supplierName.match(/\b\w/g) || [];
                        ...
                        },
                        {
                          ...
                          render: function (data, type, full, meta) {
                            ...
                            return '<span><a href="/purchaseorder/edit/' + $poID + '" class="text-heading text-truncate"><span class="fw-medium">' + $poNumber + '</a></span>';
                          }
                        ...
                        },
                        {
                          ...
                          targets: 5,
                          render: function (data, type, full, meta) {
                            var $paidAmount = full['paidAmount'];
