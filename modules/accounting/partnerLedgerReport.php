<?php
$PAGE_ID = "ACCOUNTS_PARTNER_LEDGER_REPORT";
...
<head>
    ...
    <title>GrandMaster ERP | Partner Ledger Report</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Partner Ledger Report</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="datatables-products table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td></td> <!-- Name -->
                                        <td></td> <!-- Account Name -->
                                        <td style="text-align: right;"><strong>Total Receivables:</strong></td> <!-- Reference -->
                                        <td></td> <!-- Debit -->
                                        <td></td> <!-- Credit -->
                                        <td id="footer-total-receivables"></td> <!-- Running Balance -->
                                        <td></td> <!-- Outstanding Balance -->
                                    </tr>
                                    <tr>
                                        <td style="display: none;"></td> <!-- Control column, hidden -->
                                        <td style="display: none;"></td> <!-- Checkbox column, hidden -->
                                        <td></td> <!-- Name -->
                                        <td></td> <!-- Account Name -->
                                        <td style="text-align: right;"><strong>Total Payables:</strong></td> <!-- Reference -->
                                        <td></td> <!-- Debit -->
                                        <td></td> <!-- Credit -->
                                        <td id="footer-total-payables"></td> <!-- Running Balance -->
                                        <td></td> <!-- Outstanding Balance -->
                                    </tr>
                                </tfoot>
                            </table>
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/accounting/fetch_partner_ledge.php',
                        columns: [
                      ...
                      columnDefs: [
                        ...
                        },
                        {
                          ...
                          targets: 2,
                          render: function (data, type, full, meta) {
                            var $partnerName = full['partnerName'];
                        ...
                        },
                        {
                          ...
                          targets: 4,
                          render: function (data, type, full, meta) {
                            var $referenceType = full['referenceType'];

                            return '<span>' + $referenceType + '</span>';
                          }
                        },
                        {
                          // Debit
                        ...
                        },
                        {
                          ...
                          targets: 7,
                          render: function (data, type, full, meta) {
                            var $runningBalance = full['runningBalance'];
                        ...
                        },
                        {
                          ...
                          targets: 8,
                          render: function (data, type, full, meta) {
                            var $outstanding = full['outstanding'];
                      ...
                      footerCallback: function (row, data, start, end, display) {
                        ...
                        if (json && json.summary) {
                            ...
                            $('#footer-total-receivables').html(
                                parseFloat(summary.totalReceivables).toLocaleString(undefined, { minimumFractionDigits: 2 })
                            );
                            $('#footer-total-payables').html(
                                parseFloat(summary.totalPayables).toLocaleString(undefined, { minimumFractionDigits: 2 })
                            );
                        }
                    },
                        order: [[2, 'asc']],
