<?php
$PAGE_ID = "ACCOUNTS_GENERAL_LEDGER_LIST";
...
<head>
    ...
    <title>GrandMaster ERP | General Ledgers</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">General Ledgers</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/accounting/fetch_general_ledgers.php',
                        columns: [
                      ...
                      columnDefs: [
                        ...
                        },
                        {
                          ...
                          responsivePriority: 2,
                          render: function (data, type, full, meta) {
                            var $entryDate = full['entryDate'];
                            if ($entryDate) {
                              var momentDate = moment($entryDate, 'MMM D, YYYY, h:mm A');
                              if (type === 'sort') {
                                // For sorting, return a format that sorts correctly (e.g., ISO format)
