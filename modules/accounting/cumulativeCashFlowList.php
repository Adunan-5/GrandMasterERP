<?php
$PAGE_ID = "ACCOUNTS_CUMULATIVE_CASHFLOW_LIST";
...
<head>
    ...
    <title>GrandMaster ERP | Cumulative Cash Flow</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Cumulative Cashflow</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/accounting/fetch_cumulative_cashflow.php',
                        columns: [
                      ...
                      columnDefs: [
                        ...
                        },
                        {
                          ...
                          responsivePriority: 2,
                          render: function (data, type, full, meta) {
                            var $englishMonth = full['englishMonth'];
                            var $year = full['year'];

                            if ($englishMonth && $year) {
                              // Combine month and year into a parseable string (e.g., "January 2025")
                              var monthYearString = $englishMonth + ' ' + $year;
                              var momentDate = moment(monthYearString, 'MMMM YYYY'); // Parse as full month name and year

                              if (type === 'sort') {
                                return momentDate.format('YYYYMM');
                              }
                              // For display, keep the original month name
                              return '<span>' + $englishMonth + '</span>';
                            }
                            return '-';
                          }
                        },
                        {
                          ...
                          render: function (data, type, full, meta) {
                            var $arabicMonth = full['arabicMonth'];
                            var $year = full['year'];

                            if($arabicMonth && $year) {
                              // Combine month and year into a parseable string (e.g., "يناير 2025")
                              var monthYearString = $arabicMonth + ' ' + $year;
                              var momentDate = moment(monthYearString, 'MMMM YYYY'); // Parse as full month name and year

                              if (type === 'sort') {
                                return momentDate.format('YYYYMM');
                              }
                              return '<span>' + $arabicMonth + '</span>';
                            }
                        ...
                        },
                        {
                          ...
                          targets: 6,
                          render: function (data, type, full, meta) {
                            var $vatPayable = full['vatPayable'];
                            return '<span>' + $vatPayable + '</span>';
                          }
                        },
                        {
                          // Expenses
                        ...
                        },
                        {
                          ...
                          targets: 8,
                          render: function (data, type, full, meta) {
                            var $netCashFlow = full['netCashFlow'];
                            return '<span>' + $netCashFlow + '</span>';
                          }
                        },
                        {
                          ...
                          // responsivePriority: 1,
                          render: function (data, type, full, meta) {
                            var $cumulativeCashFlow = full['cumulativeCashFlow'];
                            return '<span>' + $cumulativeCashFlow + '</span>';
                          }
                        },
