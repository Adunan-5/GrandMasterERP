<?php
$PAGE_ID = "ACCOUNTS_EXECUTIVE_SUMMARY_STATEMENT";
...
<head>
    ...
    <title>GrandMaster ERP | Executive Summary</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Executive Summary Statement</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="datatables-products table">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td style="display: none;"></td>
                                        <td style="display: none;"></td>
                                        <td style="text-align: right;"><strong>Total Revenue:</strong></td>
                                        <td></td>
                                        <td id="footer-total-revenue"></td>
                                    </tr>
                                    <tr>
                                        <td style="display: none;"></td>
                                        <td style="display: none;"></td>
                                        ...
                                        <td></td>
                                        <td id="footer-total-expenses"></td>
                                    </tr>
                                    <tr>
                                        <td style="display: none;"></td>
                                        <td style="display: none;"></td>
                                        <td style="text-align: right;"><strong>Net Profit:</strong></td>
                                        <td></td>
                                        <td id="footer-net-profit"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
            ...
            $(function () {
                ...
                if (dt_sparePart_table.length) {
                    var dt_spareParts = dt_sparePart_table.DataTable({
                        ajax: '/ajax/accounting/fetch_executive_summary.php',
                        columns: [
                      ...
                      footerCallback: function (row, data, start, end, display) {
                        ...
                        if (json && json.summary) {
                            ...
                            $('#footer-total-revenue').html(
                                parseFloat(summary.totalRevenue).toLocaleString(undefined, { minimumFractionDigits: 2 })
                            );
                            $('#footer-total-expenses').html(
                                parseFloat(summary.totalExpenses).toLocaleString(undefined, { minimumFractionDigits: 2 })
                            );
                            $('#footer-net-profit').html(
                                parseFloat(summary.netProfit).toLocaleString(undefined, { minimumFractionDigits: 2 })
                            );
                        }
                    },
                        order: [[2, 'asc']],
