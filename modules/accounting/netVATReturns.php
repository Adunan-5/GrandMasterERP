<?php
$PAGE_ID = "ACCOUNTS_NET_VAT_RETURNS_LIST";
...
<head>
    ...
    <title>GrandMaster ERP | Net VAT Returns</title>
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                              <div class="row gy-1 gy-sm-1">
                                <h4 class="my-0">Net VAT Returns</h4>
                              </div>
                            </div>
                        </div>
                    </div>
          ...
          $(function () {
            ...
            if (dt_sparePart_table.length) {
              var dt_spareParts = dt_sparePart_table.DataTable({
                ajax: '/ajax/accounting/fetch_net_VAT.php',
                columns: [
                ...
                columnDefs: [
                  ...
                  },
                  {
                    ...
                    render: function (data, type, full, meta) {
                      ...
                      return (
                        ...
                        '<a href="/vat-summary/' + $englishQuarter + '/' + $year + '" data-bs-toggle="tooltip" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill" data-bs-placement="top" title="View"><i class="ti ti-eye mx-2 ti-md"></i></a>' +
                        '</div>'
                      );
                    }
                  },
                  {
                    ...
                    render: function (data, type, full, meta) {
                      ...
                      return '<span><a href="/vat-summary/' + $englishQuarter + '/' + $year + '">' + $englishQuarterRange + '</a></span>';
                    }
                  },
                  {
                    // Arabic Quarter
                  ...
                  },
                  {
                    ...
                    targets: 6,
                    render: function (data, type, full, meta) {
                      var $vatReceivable = full['vatReceivable'];
                      return '<span>' + $vatReceivable + '</span>';
                    }
                  },
                  {
                    // Net VAT Returns
                    targets: 7,
                    render: function (data, type, full, meta) {
                      var $netVat = full['netVat'];
                      return '<span>' + $netVat + '</span>';
                    }
                  },
