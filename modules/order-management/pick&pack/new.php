...
$refOrderID = "";
$refOrderID = filter_input(INPUT_GET, 'refOrderID', FILTER_VALIDATE_INT);
if ($refOrderID === null || $refOrderID === false || filter_var($refOrderID, FILTER_VALIDATE_INT) === false) {
  ...
  <div class="layout-container">
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
          ...
          $res = $db->query("SELECT * FROM `order_management_documents` where orderManagementId = ?s", $refOrderID);
          ...
          $lineitemRes = $db->query("SELECT * FROM `pick_and_pack_line_items` where orderManagementId = ?s AND orderWHStatus = ?s", $refOrderID, ORDER_WH_STATUS_RESERVED);
          ?>
        <!-- Content -->
                  ...
                  <div class="row">
                      ...
                      <dl class="row mb-0">
                        ...
                        <dd class="col-md-8 col-sm-7">
                          <div class="input-group input-group-merge disabled">
                            ...
                            <input name="gdnNumber" id="gdnNumber" type="text" class="form-control" disabled placeholder="Will be generated once saved / confirmed" value="NEW"/>
                          </div>
                          <input name="gdnID" id="gdnID" type="hidden" value=""/>
                        </dd>
                        <dt class="col-md-4 col-sm-5 mb-2 text-md-end d-flex align-items-center">
                          <span class="fw-normal">Carrier:</span>
                        </dt>
                        <dd class="col-md-8 col-sm-7">
                          <input type="text" id="carrier" class="form-control" value=""/>
                        </dd>
                        <dt class="col-md-4 col-sm-5 mb-2 text-md-end d-flex align-items-center">
                          <span class="fw-normal">Carrier Waybill#:</span>
                        </dt>
                        <dd class="col-md-8 col-sm-7">
                          <input type="text" id="carrierWayBillNo" class="form-control" value=""/>
                        </dd>
                      </dl>
                    </div>
                    ...
                    <div class="col-md-4 col-12 mb-4">
                      <dl class="row mb-0">
                        ...
                        <dd class="col-md-8 col-sm-7">
                          <input type="text" id="packageValue" class="form-control" value=""/>
                        </dd>
                        <dt class="col-md-4 col-sm-5 mb-2 text-md-end d-flex align-items-center">
                          <span class="fw-normal">Box Qty:</span>
                        </dt>
                        <dd class="col-md-8 col-sm-7">
                          <input type="text" id="boxQty" class="form-control" value=""/>
                        </dd>
                        <dt class="col-md-4 col-sm-5 mb-2 text-md-end d-flex align-items-center">
                          <span class="fw-normal">Shipping Date:</span>
                        </dt>
                        <dd class="col-md-8 col-sm-7">
                          <input name="shippingDate" id="shippingDate" type="text" class="form-control gmm-date-format" placeholder="DD - MMM - YYYY" value="<?= date('Y-m-d')?>"/>
                        </dd>
                      </dl>
                    </div>
                    <div class="col-md-4 col-12 mb-4">
                      <dl class="row mb-0">
                        ...
                        <dd class="col-md-6 col-sm-7">
                          <span id="shippingSubTotal" class="fw-medium">SAR 0.00</span>
                        </dd>
                      </dl>
                    </div>
                  </div>
                            ...
                            <div class="d-flex border rounded position-relative pe-0">
                              <div class="row w-100 p-3">
                                ...
                                <div class="col-md-1 col-12 mb-md-0 mb-4">
                                  ...
                                  <?php
                                      $displayStyle = ($orderDATA['transactionType'] == 'TRANSFER') ? 'style="display: none"' : '';
                                  ?>
                                  <div class="col-md-2 col-12 mb-md-0 mb-4" <?= $displayStyle ?>>
                                ...
                                <div class="col-md-2 col-12 mb-md-0 mb-4">
                                  ...
                                  <input name="shipment#" type="text" class="form-control" placeholder="Shipment#" min="1"
                                         required readonly value="<?= getShipmentNumberFromOrderAndIPickAndPackID($refOrderID, $lineitemrow['pickAndPackLineItemId']) ?>" />
                                </div>
                                    <div class="col-md-2 col-12 mb-md-0 mb-4">
...
<script>
  ...
  //function printGDN() {
  //
  //  let documentID = "<?php //= $orderManagementID ?>//";
  ...
  //  saveBOLThread('<?php //=BOL_STATUS_PROCUREMENT_MANAGER_APPROVAL ?>//');
  //}
  //
  //function approveBOL() {
  //  let documentID = '<?php //=$bolPresent ? $bolDATA['bolId'] : ''?>//';
  //  updateBOLStatus(documentID, "<?php //=BOL_STATUS_PROCUREMENT_MANAGER_APPROVED?>//");
  //}
  //
  //function rejectBOL() {
  //  let documentID = '<?php //=$bolPresent ? $bolDATA['bolId'] : ''?>//';
  ...
  //    updateBOLStatus(documentID, "<?php //=BOL_STATUS_PROCUREMENT_MANAGER_REJECTED ?>//", true, rejectReason);
  //  } else {
  ...
  //function createBOL() {
  //  let documentID = '<?php //=$bolPresent ? $bolDATA['bolId'] : ''?>//';
  //  updateBOLStatus(documentID, "<?php //=BOL_CREATED?>//");
  //}
  //
  ...
  //        if (showMessage)
  //          showSuccessMessage(message, gotoPage, '/shipment/order/edit/' + <?php //=$shipmentID?>//);
  //      }
  //    },
  //
