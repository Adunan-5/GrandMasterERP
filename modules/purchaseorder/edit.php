            ...
            <div class="card-widget-separator-wrapper">
              <div class="card-body card-widget-separator py-2">
                <div class="row gy-1 gy-sm-1">
                  <div class="col-6">
                    <h4 class="my-0"> <?= getPONumberFromDocumentID($poDATA['poId']) ?> | Edit Purchase Order</h4>
                  </div>
                            ...
                            <div class="d-flex border rounded position-relative pe-0">
                              <div class="row w-100 p-3">
                                ...
                                <div class="col-md-1 col-12 mb-md-0 mb-4">
                                  ...
                                  <input name="uom" type="text" class="form-control mb-5" readonly
                                         value="<?= getUOMNameFromID($lineitemrow['UOM']); ?>" />
                                  <input name="uomId" type="hidden" class="form-control mb-5" readonly
                                         value="<?= $lineitemrow['UOM'] ?>" />
                                </div>
                                <!--                                <div class="col-md-1 col-12 mb-md-0 mb-4">-->
                                <!--                                  <p class="h6 mb-1">UOM</p>-->
                                ...
                                <!--                                      --><?php
                                  ...
                                  //                                          ?>
                                <!--                                        <option -->
                                  <?php //if($lineitemrow['UOM'] == $row['uomId'])  echo 'SELECTED'?><!-- value="-->
                                  <?php //= $row['uomId'] ?><!--" data-type="-->
                                  <?php //= $row['type'] ?><!--" data-ratio="-->
                                  <?php //= $row['ratio'] ?><!--">-->
                                  <?php //= $row['uomName'] ?><!--</option>-->
                                <!--                                          --><?php
                                  //                                      }
                                  //                                      ?>
                                <!--                                  </select>-->
                                ...
                                <div class="col-md-1 col-12 mb-md-0 mb-4">
                                  ...
                                  <input name="cost" type="text" class="form-control numbers-only calculation-trigger"
                                         placeholder="Cost" min="1" required value="<?= $lineitemrow['costPrice'] ?>"
                                         readonly />
                                </div>
                                <div class="col-md-1 col-12 mb-md-0 mb-4">
                        ...
                        <div class="offcanvas-body pt-0 flex-grow-1">
                            ...
                            <div class="mt-5">
                                <ul class="timeline mb-0">
                                    ...
                                    $poDocumentHistory = new POHistory();
                                    $poDocumentHistory->loadByPOId($poID);

                                    foreach ($poDocumentHistory->timeline as $historyItem) {
                                        ?>
...
<script>
  ...
  function printPO() {
    ...
    const relativeUrl = '/ajax/podocument/generate_pdf.php?poID=' + '<?=$poID ?>';
  ...
  function savePayment() {
    ...
    if ($('#amountPaid').val().length > 0 && $('#paymentMode').val().length > 0) {
      ...
      $.ajax(
        {
          url: '/ajax/podocument/update_payment_details.php', // Update with your PHP script URL
          method: 'POST',
          ...
          success: function (response) {
            ...
            if (response.status === 'success') {
              ...
              showSuccessMessage(response.message, gotoPage, "/purchaseorder/edit/" + '<?=$poID?>');
