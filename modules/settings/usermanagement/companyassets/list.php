...
<head>
    ...
    <title>GrandMaster Company Assets</title>
    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card-widget-separator-wrapper">
                            <div class="card-body card-widget-separator py-2">
                                <div class="row gy-1 gy-sm-1">
                                    <h4 class="my-0">Company Assets</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:;"
                                                   ...
                                                   data-assetstatus="<?= $row['active'] ?>" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAssetEdit" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill termEditButton" data-bs-placement="top" title="Edit"><i class="ti ti-pencil mx-2 ti-md"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                ...
                <!--Add Form-->
                <div class="offcanvas offcanvas-end form-block" tabindex="-1" id="offcanvasAssetAdd">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title">Add Asset</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body border-top mx-0 flex-grow-0">
                        <form class="ecommerce-customer-add pt-0" id="assetAddForm" method="POST" name="assetAddForm" onsubmit="return false;">
                            <div class="ecommerce-customer-add-basic mb-4">
                                <div class="mb-6">
                                    <label class="form-label" for="assetName">Asset Name*</label>
                                    <input type="text" class="form-control" id="assetName" placeholder="HP Laptop" name="assetName" aria-label="App Development"/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="description">Description</label>
                                    <input type="text" id="description" class="form-control" placeholder="Device to Communicate" aria-label="Value" name="description"/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="assetStatus">Status</label>
                                    <select id="assetStatus" name="assetStatus" class="selectpicker w-100" data-style="btn-default" data-live-search="true">
                ...
                <!--Edit Form-->
                <div class="offcanvas offcanvas-end form-block" tabindex="-1" id="offcanvasAssetEdit">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title">Edit Asset</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body border-top mx-0 flex-grow-0">
                        <form class="ecommerce-customer-add pt-0" id="assetEditForm" method="POST" name="assetEditForm" onsubmit="return false;">
                            <div class="ecommerce-customer-add-basic mb-4">
                                <div class="mb-6">
                                    <label class="form-label" for="editAssetID">Asset ID</label>
                                    <input type="text" class="form-control" id="editAssetID" name="assetID" readonly value=""/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="editAssetName">Asset Name*</label>
                                    <input type="text" class="form-control" id="editAssetName" placeholder="HP Laptop" name="editAssetName" aria-label="App Development"/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="description">Description</label>
                                    <input type="text" id="editDescription" class="form-control" placeholder="Device to Communicate" aria-label="Value" name="description"/>
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="assetStatus">Status</label>
                                    <select id="editAssetStatus" name="assetStatus" class="w-100" data-style="btn-default" data-live-search="true">
                                        <option data-tokens="active" value="1">Active</option>
                                        <option data-tokens="inactive" value="0">Inactive</option>
                                    </select>
                                </div>
...
<script>
  ...
  $(function () {
    ...
    if (dt_invoice_table.length) {
      ...
      var dt_invoice = dt_invoice_table.DataTable({
        ...
        buttons: [
          {
            text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">New Asset</span>',
            className: 'btn btn-primary waves-effect waves-light',
            attr: {
              'data-bs-toggle': 'offcanvas',
              'data-bs-target': '#offcanvasAssetAdd'
            }
          }
        ],
  ...
  $(document).ready(function () {
    ...
    const fv = FormValidation.formValidation(assetAddForm, {
      fields: {
        assetName: {
          validators: {
            notEmpty: {
    ...
    const editFormValidation = FormValidation.formValidation(assetEditForm, {
      fields: {
        editAssetName: {
          validators: {
            notEmpty: {
    ...
    $("#assetAddForm").submit(function (e) {
      e.preventDefault();
      ...
      fv.validate().then(function (status) {
        if (status === 'Valid') {
          ...
          $.ajax({
            url: '/ajax/settings/usermanagement/users/add_asset.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            success: function (data, status) {
              ...
              if (statusmessage == "SUCCESS") {
                ...
                Swal.fire({
                  ...
                  function (result) {
                    dismissOffcanvas('offcanvasAssetAdd');
                    blockArea($('body'));
                    location.reload();
                  }
                );
    ...
    $("#assetEditForm").submit(function (e) {
      ...
      editFormValidation.validate().then(function (status) {
        if (status === 'Valid') {
          ...
          var form = $("#assetEditForm")[0]; // You need to use standard javascript object here
          var formData = new FormData(form);
          ...
          $.ajax({
            url: '/ajax/settings/usermanagement/users/update_asset.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            success: function (data, status) {
              ...
              if (statusmessage == "SUCCESS") {
                ...
                Swal.fire({
                  ...
                  function (result) {
                    dismissOffcanvas('offcanvasAssetEdit');
                    blockArea($('body'));
                    location.reload();
                  }
                );
  ...
  $(document).on('click', '.termEditButton', function (e) {
    ...
    let assetStatus = $(this).data("assetstatus");
    ...
    $('#editAssetStatus').val(assetStatus).trigger('change');
  });
</script>
<style>
    #offcanvasAssetAdd {
