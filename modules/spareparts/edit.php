<?php
$PAGE_ID = "SPARE_PART_VIEW";
include_once __DIR__ . "/../../includes/baseIncludes.php";
include_once __DIR__ . "/../../includes/auth_check.php";

$sparepartID = "";

$sparepartID = filter_input(INPUT_GET, 'sparepartID', FILTER_VALIDATE_INT);

if ($sparepartID === null || $sparepartID === false || filter_var($sparepartID, FILTER_VALIDATE_INT) === false) {
    header("location:/spareparts/list");
    exit();
}
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    $sparepart->loadById($sparepartID);
                    ?>
                    <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between mb-6 text-center text-sm-start gap-2">
                        <div class="mb-2 mb-sm-0">
                            <h4 class="mb-1">Part Number #<?= $sparepart->partNumber ?></h4>
                        </div>
                            ...
                            <div class="card mt-6">
                                <div class="info-container m-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                        <a href="javascript:;" class="btn btn-primary me-2" data-bs-target="#editSparepartModal" data-bs-toggle="modal">
                                            Edit Details
                                        </a>
                                ...
                                <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex align-items-center flex-column">
                                            ...
                                            <div class="sparepart-info text-center mb-6">
                                                <table class="table">
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-end">Part Number:</td>
                                                        <td class="text-start"><?= htmlspecialchars($sparepart->partNumber) ?></td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="row text-left mb-3">
                                        ...
                                        <div class="col-6">
                                            <span>Part Name: </span><br><strong><?= $sparepart->name ?></strong>
                                        </div>
                                    </div>
                                    <div class="row text-left mb-3">
                                        <div class="col-6">
                        ...
                        <div class="col-12 col-lg-6 col-md-6 order-1 order-md-0">
                            <div class="card mt-6">
                                <div class="card-body">
                                    ...
                                    $res        = $db->query("SELECT sum(quantity) as totalQuantity FROM inventory_stock WHERE sparepartId = ?s", $sparepartID);
                                    ...
                                    <?php if ($hasStock == false) {
                                        ...
                                        <table class="table mt-4" >
                                            ...
                                            while($warehouseRow=mysqli_fetch_assoc($warehouseRes))
                                            {
                                                ...
                                                $stockRes = $db->query("SELECT * FROM inventory_stock WHERE sparepartId = ?s and warehouseId = ?s", $sparepartID, $warehouseRow['warehouseId']);
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="text-center mb-6">
                                        <h4 class="mb-2">Modify Sparepart Information</h4>
                                        <!--                                        <p>Updating user details will receive a privacy audit.</p>-->
                                    </div>
                                    <form class="ecommerce-sparepart-add pt-0" id="sparepartEditForm" method="POST" name="sparepartEditForm" enctype="multipart/form-data" action="#" onsubmit="return false;">
                                        <!--HIDDEN FIELDS-->
                                        ...
                                        <div class="ecommerce-sparepart-add-basic mb-4">
                                            <div class="row">
                                                <div class="mb-6  col-6">
                                                    ...
                                                    <input type="text" class="form-control" id="partNumber" readonly placeholder="Part Number" name="partNumber" aria-label="Mohammed Faisal" value="<?= $sparepart->partNumber ?>"/>
                                                </div>
                                                <div class="mb-6 col-6">
                                                ...
                                                <div class="mb-6 col-6">
                                                    ...
                                                    <input type="text" id="leadTime" class="form-control phone-mask" placeholder="5 days" name="leadTime" value="<?= $sparepart->leadTime ?>"/>
                                                </div>
                                                <div class="mb-6 col-6">
                        ...
                        <div class="offcanvas-body pt-0 flex-grow-1">
                            ...
                            <div class="mt-5">
                                <ul class="timeline mb-0">
                                    ...
                                    $sparepartHistory->loadBySparepartId($sparepartID);
...
<script>
    $(document).ready(function () {
        // Form Validation
        const sparepartEditForm = document.getElementById('sparepartEditForm');

        // Add New sparepart Form Validation
        const fv = FormValidation.formValidation(sparepartEditForm, {
            fields: {
                // partNumber: {
                //     validators: {
                //         notEmpty: {
        ...
        $("#sparepartEditForm").submit(function (e) {
            e.preventDefault();
        ...
        $("#updateNewQuantityButton").click(function (e) {
            ...
            if (newQuantity === null || newQuantity === "") {
                ...
                const data = {
                    sparepartID: <?= json_encode($sparepartID); ?>,
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status === "SUCCESS") {
                            showSuccessMessage("Quantity successfully updated", gotoPage, '/spareparts/edit/' + '<?=$sparepartID?>');
