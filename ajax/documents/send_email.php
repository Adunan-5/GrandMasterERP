...
//[quotation-to] => pravidnut@dunkinksa.com
//[quotation-subject] => GrandMaster Quotation GM-Q-00005
//[quotation-message] => Dear Shahia food limited company ,
//[documentID]
...
$res = $db->query("UPDATE `key_documents` SET `customerPassword`=?s, `quotationAcceptedByCustomer`='NEUTRAL' WHERE  `documentId`=?s", $customerPassword, $documentID);



$templateFilePath = __DIR__ . '/../../emailtemplates/sparepartquotation.html';
...
<br><br>To accept or reject the quotation, click on the link below. Please note that, the link is password protected. Use the password <strong>$customerPassword</strong> to access your quotation. Thank you. 
<br><br>
